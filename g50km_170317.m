...
load newBATH50
% newBATH50(1,:) = [];
remove = find(newBATH50(:,3) == -9999);
newBATH50(remove,:) =[];

% create a find and replace for the elevations above sea level
load new50km
new50km(1,:) = [];
replace = find(new50km(:,3) <= 0);
new50km(replace,:) = newBATH50(replace,:);
